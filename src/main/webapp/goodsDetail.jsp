...
<body>
	<%@ include file="header.jsp"%>
	   ...
	   <ol class="breadcrumb">
		  <li><a href="#">小米商城</a></li>
		  <li><a href="#">手机</a></li>
		  <li class="active"><a href="getGoodsList?typeid=${goods.tid}">${goods.pname}</a></li>
	   </ol>
   </div>
			  ...
			  <div class="panel-body">
			    ...
			    <div style="margin-left: 10px;">
				   ...
				   <p>市场价格:&nbsp;&nbsp;&nbsp;<span class="text-danger" style="font-size: 15px;">${goods.pprice}</span>&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-yen"></span></p>
				    ...
				    <p>详细介绍:</p>
				    <p>&nbsp;&nbsp;${goods.pinfo }</p>
				    <a href="${pageContext.request.contextPath}/car?method=addCart&pid=${goods.pid}&price=${goods.pprice}" class="btn btn-warning">加入购物车&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-shopping-cart"></span></a>&nbsp;&nbsp;&nbsp;
