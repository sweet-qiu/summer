	...
	<div class="regist">
		<div class="regist_center">
			...
			<div class="center-block" style="margin-top: 80px;">
				<form class="form-horizontal" action="${pageContext.request.contextPath}/controller?method=register" method="post">

					<div class="form-group">
						<label class="col-sm-2 control-label">用户名</label>
						<div class="col-sm-8" style="width: 40%">
							<input type="text" id="username" name="name" class="form-control col-sm-10"
